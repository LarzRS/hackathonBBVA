# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in bbva.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': bbva.model,
    'DBSession': bbva.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "9eff02a2-20ab-464d-b636-9e929967a7b0",
